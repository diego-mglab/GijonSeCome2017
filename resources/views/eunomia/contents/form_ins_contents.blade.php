...
@section('js')
    ...
    <script>
        var options = {
            filebrowserImageBrowseUrl: '{{asset('vendor/laravel-filemanager?type=Images')}}',
            filebrowserImageUploadUrl: '{{asset('vendor/laravel-filemanager/upload?type=Images&_token='.csrf_token())}}',
            filebrowserBrowseUrl: '{{asset('vendor/laravel-filemanager?type=Files')}}',
            filebrowserUploadUrl: '{{asset('vendor/laravel-filemanager/upload?type=Files&_token='.csrf_token())}}'
        };
        $('#contenido').ckeditor(options);
    </script>
